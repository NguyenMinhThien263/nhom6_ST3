...
<head>
  ...
  <link href="{{ asset('css/style.min.css') }}" type="text/css" rel="stylesheet">
    ...
    @if($mod=='')
        ...
        @endphp
    @elseif($mod=='list')
      <link href="{{asset('/css/style_listfilm.css') }}" type="text/css" rel="stylesheet">
    @elseif($mod=='detail')
      <link href="{{asset('/css/style-detail.css') }}" type="text/css" rel="stylesheet">
    @elseif ($mod=='watch')
      <link rel="stylesheet" type="text/css" media="screen" href="{{asset('./css/style_watch') }}" />
      <script src="{{asset('/js/watch.js')}}"></script>
      <link rel="stylesheet" href="{{asset('https://use.fontawesome.com/releases/v5.3.1/css/all') }}" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
